-- Assessa Pulse (plan): Mentimeter-style live slides with MCQ / text / rating,
-- UUID + join code, and reveal_mode live | all_in | host.
-- Replaces earlier pulse wall schema (questions/reactions/anonymous guests).
