...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Assessa — Online Assessment & Examination Platform" },
      {
        name: "description",
        content:
          "Create, publish and run online assessments with participant profiles, server-scored results, analytics and gamification.",
      },
